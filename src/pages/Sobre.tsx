...
const Sobre = () => {
  useEffect(() => {
    document.title = "Sobre Nós | Desentupidora Precisão — Belo Horizonte";
  }, []);
    ...
    <div className="min-h-screen">
      ...
      <section className="bg-primary-dark pt-24 pb-16 md:pt-32 md:pb-20">
        <div className="container">
          <h1 className="font-display text-3xl font-extrabold text-white md:text-5xl">
            Sobre a <span className="text-accent">Desentupidora Precisão</span>
          </h1>
      ...
      <section className="py-16 md:py-20">
        <div className="container grid gap-10 md:grid-cols-2 items-center">
          <div>
            <h2 className="font-display text-2xl font-extrabold text-foreground md:text-3xl mb-6">
              Nossa história
            </h2>
            <div className="space-y-4 text-muted-foreground leading-relaxed">
              <p>A Desentupidora Precisão nasceu da necessidade de oferecer um serviço de desentupimento realmente profissional em Belo Horizonte. Cansados de ver clientes mal atendidos e serviços mal executados, decidimos criar uma empresa que prioriza qualidade, rapidez e transparência.</p>
          ...
          <img src={teamImg} alt="Equipe Desentupidora Precisão" width={800} height={600} loading="lazy" className="rounded-2xl shadow-lg" />
        </div>
      </section>
