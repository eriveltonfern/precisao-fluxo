...
const Contato = () => {
  useEffect(() => {
    document.title = "Contato | Desentupidora Precisão — Belo Horizonte";
  }, []);
        ...
        <div className="container grid gap-10 md:grid-cols-2">
          <div>
            ...
            <div className="space-y-6">
              {[
                { icon: Phone, label: "Telefone", value: "(31) 9999-9999", href: "tel:+553199999999" },
                { icon: MessageCircle, label: "WhatsApp", value: "Fale conosco agora", href: whatsappLink },
                { icon: Mail, label: "E-mail", value: "contato@desentupidoraprecisao.com.br", href: "mailto:contato@desentupidoraprecisao.com.br" },
                { icon: MapPin, label: "Endereço", value: "Belo Horizonte, MG", href: "#" },
